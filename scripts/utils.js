...
2. 【季節の訴求】「秋の連休（シルバーウィーク・紅葉）や年末年始の旅行に向けた早めの予約」を促すトーンを追加してください。
3. **【重要】**万一人物像やファッションに言及する場合は、常に「どの季節で見ても違和感がない」通年仕様（seasonless）のルールを厳格に維持してください。
4. 「バグ級」「コスパ崩壊」「発見！」などの品のない安易な煽りワードは一切禁止します。
5. 読者の感情や五感に寄り添い、落ち着いた魅力が伝わる文章にしてください。
6. 楽天APIの元の説明文の単なるコピペは禁止です。
